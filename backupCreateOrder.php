...
<!-- Form Add Item -->
			...
			<tr>
				...
				<tr>
					...
					<td><input id="qty" name="qty" style="width:200px" class="easyui-numberbox" required="true" data-options="min:0,precision:4,decimalSeparator:'.',groupSeparator:','"></td>
...
<script type="text/javascript">		
	...
	function clearForm(){
		...
		$('#qty, #uom, #price, #total, #moq, #spq').numberbox({
			value:''
		})
		$('#remark').val("");
		$('#curr').val("");
